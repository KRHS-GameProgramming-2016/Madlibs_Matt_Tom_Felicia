...
def story():
    ...
    text += " s/he was always later so I " + Noun 
    text += " it was " + time " when s/he arived " 
    text += " I asked " + Name " what took him/her " + Noun
    text += " s/he said " + Name " was talking to me about" + pronoun
    text += " I looked at her/him and thought of " + Noun
    text += " but then " + name " walked up to me and asked me if I was ok I said" + adajetive
    text += " I then sais we shoud go to " + restront Name " for lunch "
    text += " I know how much " + Name " loved there" + Food
    text += " we starwd walking to " + restront Name 
    text += " we stard taking about " + Noun
    text += " after some time past we made it to the restront I looked at my wach to see it wat " + time 
    text += " I then remaber that I had to pick up my sister " + Name 
